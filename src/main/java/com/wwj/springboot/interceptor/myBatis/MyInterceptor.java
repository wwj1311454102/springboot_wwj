package com.wwj.springboot.interceptor.myBatis;

import com.wwj.springboot.util.ReflectUtil;
...
//        SqlSource sqlSource = ReflectUtil.getField(mappedStatement, SqlSource.class);
        SqlSource sqlSource = ReflectUtil.getMethodField(mappedStatement, SqlSource.class);
